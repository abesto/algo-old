 ...
 *
 * Graph implementation using net.abesto.SAS
 *
...
Node: (function() {
    var Constructor = function()
    {
        ...
        this._emit = net.abesto.SAS.emitFunction(this);
    };
    ...
    Constructor.prototype.neighbors = function() {
        var ns = new UIDObjectStore(), that = this;
        this.edges().each(function(e) {
            ns.add(e.otherNode(that));
        });
        return ns;
    };
    ...
    Constructor.prototype.distanceFrom = function(b) {
        return Node.distance(this, b);
    }

    Constructor.distance = function(a, b) {
        if (!a.neighbors().has(b)) return infinity;
        return Math.round(
                Math.sqrt(
                        Math.pow((a.ui.attr('cx') - b.ui.attr('cx')), 2) +
                        Math.pow((a.ui.attr('cy')) - b.ui.attr('cy'), 2)
                        )
                );
    };
...
Edge: (function() {
    ...
    Constructor.prototype.deleted = function() {
        net.abesto.SAS.emit('deleted', this.UID);
    }
...
Graph: (function() {
    var Constructor = function() {
        ...
        this.edges = function() { return edges; };
        this._emit = net.abesto.SAS.emitFunction(this);
        this._reEmit = net.abesto.SAS.reEmitFunction(this);
    };

    Constructor.prototype.newNode = function() {
        var n = new Node();
        this.nodes().add(n);
        net.abesto.SAS.addSlot(this._reEmit, n.UID);
